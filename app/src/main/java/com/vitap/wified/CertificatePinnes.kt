 ...
 * CertificatePinners CertificatePinners = new CertificatePinners.Builder()
 ...
 *   at okhttp3.CertificatePinners.check(CertificatePinners.java)
 ...
 *
 * [CertificatePinners] can not be used to pin self-signed certificate if such certificate is not
...
class CertificatePinners internal constructor(
    ...
    internal fun withCertificateChainCleaner(
        ...
        return if (this.certificateChainCleaner == certificateChainCleaner) {
            ...
            CertificatePinners(pins, certificateChainCleaner)
        }
    }

    override fun equals(other: Any?): Boolean {
        return other is CertificatePinners &&
                other.pins == pins &&
    ...
    class Builder {
        ...
        fun build(): CertificatePinners = CertificatePinners(pins.toSet(), null)
    }
    ...
    companion object {
        ...
        internal fun newPin(pattern: String, pin: String): Pin {
            ...
            val canonicalPattern = pattern
            //val canonicalPattern = pattern.toCanonicalHost() ?: throw IllegalArgumentException("Invalid pattern: $pattern")
